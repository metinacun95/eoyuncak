    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			<div id="page-inner">
				...
				<div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Katalog Düzenle</h1>
                        <h1 class="page-subhead-line">Katalog Bilgilerini girerek kataloğu güncelleyebilirsiniz.</h1>
					...
					<div id="basarili" class="col-md-4 " style="width:100%;">
						<div class="alert alert-success text-center">
							<h4>Katalog dosyası başarı ile güncellendi.Lütfen bekleyin...</h4> 
							<hr />
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input  name="katalog_adi" class="form-control" type="text" value="Katalog Adı" />
                                            <p class="help-block">Katalog Adı giriniz.</p>
                                        </div>
										<div class="form-group">
											<label class="control-label col-lg-4" style="width:100%; margin-left:-15px;">Yeni Pdf Dosyası Seç</label>
											<div class="">
												<div class="fileupload fileupload-new" data-provides="fileupload">
													<span class="btn btn-file btn-default">
														<span class="fileupload-new">Yeni Dosya Seç</span>
