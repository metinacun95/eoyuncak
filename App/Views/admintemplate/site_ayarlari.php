    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			<div id="page-inner">
				...
				<div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Genel Site Ayarları</h1>
                        <h1 class="page-subhead-line">Genel Site ayarlarınızı bu sayfadan ekleyebilirsiniz.</h1>
					...
					<div id="basarili" class="col-md-4 " style="width:100%;">
						<div class="alert alert-success text-center">
							<h4>Site Ayarlarınız kaydedilmiştir. Lütfen bekleyin...</h4> 
							<hr />
                        ...
                        <div class="panel-body">						
                            <form role="form" method="post" action="">
                                        <div class="form-group">
                                            ...
                                            <input  name="site_baslik" required class="form-control" type="text" maxlength="160" value="Site Başlık" required/>
                                            <p class="help-block">Site başlığı giriniz.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Keywords (Anahtar Kelimeler)</label>
                                            <textarea id="keywords" required name="keywords" class="form-control" rows="3" style="max-width:100%;" maxlength="160" required>Anahtar Kelimeler</textarea>
											<p class="help-block">Sitenizi tanımlayan anahtar kelimeler giriniz. (Örn : mobilya,mutfak,genç odası vb.)</p>
                                        </div>	
										<div class="form-group">
                                            <label>Description (Açıklama)</label>
                                            <textarea id="description" required name="description" class="form-control" rows="3" style="max-width:100%;" maxlength="160" required>Site Açıklaması</textarea>
											<p class="help-block">Site açıklaması giriniz.</p>
                                        </div>											
