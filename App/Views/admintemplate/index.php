...
<body>
        ...
        <div id="page-wrapper">
			<div id="page-inner">
                <!-- #################################################### -->
					...
					<p style="text-align:center; margin-top:50px; font-size:22px;">Bu panel tamamıyla örnek amaçlıdır herhangi bir işlevde bulunmamaktadır.</p>
					<p style="text-align:center; margin-top:50px; font-size:22px;">Menü kısmı ve içerikler sizin isteklerinize göre ayarlanacaktır. </p>
					<p style="text-align:center; margin-top:50px; font-size:22px;">Bu paneldeki içerikler örnek amaçlı olup ön bilgi edinmeniz içindir.</p>
    ...
    <div id="footer-sec">
        &copy; 2017 | Design By : <a href="http://www.metinacun.com" target="_blank">Metin ACUN</a>
    </div>
    <!-- /. FOOTER  -->
