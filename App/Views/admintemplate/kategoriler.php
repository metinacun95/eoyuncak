    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			<div id="page-inner">
				...
				<div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Kategori Düzenle / Sil</h1>
                        <h1 class="page-subhead-line">Bu sayfada eklemiş olduğunuz Kategorileri
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
												...
												<td>Kategori1</td>	
												<td>01-01-2016</td>	
												<td><a href="kategori_duzenle.php"><i class="fa fa-retweet fa-2x"></i></a></td>
