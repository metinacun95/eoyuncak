			...
			<div id="page-inner">
				...
				<div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">Kategori bilgilerini girerek güncelleyebilirsiniz.</h1>
					...
					<div id="basarili" class="col-md-4 " style="width:100%;">
						<div class="alert alert-success text-center">
							<h4>Kategori başarı ile güncellendi.</h4> 
							<hr />
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input  name="kategori_adi" class="form-control" type="text" value="Değiştirilecek Kategori Adı" required />
                                            <p class="help-block">Kategori adını giriniz</p>
                                        </div>		
