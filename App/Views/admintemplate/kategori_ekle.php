    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			<div id="page-inner">
				...
				<div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Yeni Kategori Ekle</h1>
                        <h1 class="page-subhead-line">Kategori adını girerek yeni hizmet ekleyebilirsiniz.</h1>
					...
					<div id="basarili" class="col-md-4 " style="width:100%;">
						<div class="alert alert-success text-center">
							<h4>Kategori başarı ile eklenmiştir.</h4> 
							<hr />
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input  name="kategori_adi" class="form-control" type="text" required />
                                            <p class="help-block">Kategori Adı giriniz.</p>
                                        </div>

                                        <input type="submit" class="btn btn-info" value="Kategoriyi Ekle"/>
