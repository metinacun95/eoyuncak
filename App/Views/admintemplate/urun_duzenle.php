			...
			<div id="page-inner">
				...
				<div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">Ürün bilgilerini girerek güncelleyebilirsiniz.</h1>

                    </div>
					<!-- BAŞARILI MESAJI -->
					<div id="basarili" class="col-md-4 " style="width:100%;">
						<div class="alert alert-success text-center">
							<h4>Ürün başarı ile güncellendi.</h4> 
							<hr />
                        ...
                        <div class="panel-body">						
									<form role="form" method="post" action="">
                                        <div class="form-group">
                                            ...
                                            <input  name="urun_adi" class="form-control" type="text" value="Düzenlenecek Ürün Adı" required />
                                            <p class="help-block">Ürün Adı giriniz.</p>
                                        </div>																				
										<div class="form-group">
                                            <label>Ürün Kategorisi</label>
                                            <select name="kategori" class="form-control">
													<option selected>Kategori2</option>	
													<option>Kategori1</option>	
													<option>Kategori3</option>	
													<option>Kategori4</option>	
													<option>Kategori5</option>	
                                            </select>
                                        </div>
										<div class="form-group">
