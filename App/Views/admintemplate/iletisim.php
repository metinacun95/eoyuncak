				...
				<div class="row">
					...
					<div id="basarili" class="col-md-4 " style="width:100%;">
						<div class="alert alert-success text-center">
							<h4>İletişim bilgileriniz başarıyla güncellenmiştir. Lütfen bekleyin...</h4> 
							<hr />
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="" >
                                        <div class="form-group">
                                            ...
                                            <input  name="telno" required class="form-control" maxlength="15" type="tel" value="0000 000 00 00" required/>
                                            <p class="help-block">Telefon Numaranızı girin.</p>
                                        </div>
										<div class="form-group">
                                            <label>Cep Telefon Numarası</label>
                                            <input  name="ceptelno" required class="form-control" maxlength="15" type="tel" value="0000 000 00 00" required/>
                                            <p class="help-block">Cep Telefon Numaranızı girin.</p>
                                        </div>
										<div class="form-group">
                                            <label>E-Mail Adresiniz</label>
                                            <input  name="email" required class="form-control" maxlength="60" type="email" value="email@gmail.com" required/>
                                            <p class="help-block">E-Mail adresinizi girin.</p>
                                        </div>
										<div class="form-group">
                                            <label>Facebook Adresiniz</label>
                                            <input  name="facebook" required class="form-control" type="url" value="http://facebook.com/face-adresim" required/>
                                            <p class="help-block">Facebook adresinizi girin.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Adres</label>
                                            <textarea id="keywords" required name="adres" maxlength="80" class="form-control" rows="3" style="max-width:100%;" required>Adresim</textarea>
											<p class="help-block">Ofis adresinizi girin.</p>
                                        </div>								
