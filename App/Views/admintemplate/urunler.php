			...
			<div id="page-inner">
				...
				<div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">Bu sayfada eklemiş olduğunuz makaleleri
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>									
												...
												<td>1</td>
												<td>Ürün 1</td>												
												<td><i class='fa fa-check'></i> Gösteriliyor </td>
												<td>Kategori 2</td>											
												<td><a href="urun_duzenle.php"><i class="fa fa-retweet fa-2x"></i></a></td>
												...
												<td>3</td>
												<td>Ürün 3</td>												
												<td><i class='fa fa-times'></i> Seçilmemiş </td>
												<td>Kategori 1</td>											
												<td><a href="urun_duzenle.php"><i class="fa fa-retweet fa-2x"></i></a></td>
												<td><a href="#" onclick="return silOnayla();")><i class="fa fa-trash-o fa-2x"></i></a></td>
												</tr>
