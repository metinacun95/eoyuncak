    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			<div id="page-inner">
				...
				<div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Yeni Katalog Ekle</h1>
                        <h1 class="page-subhead-line">Katalog Bilgilerini girerek yeni katalog ekleyebilirsiniz.</h1>
					...
					<div id="basarili" class="col-md-4 " style="width:100%;">
						<div class="alert alert-success text-center">
							<h4>Katalog başarı ile eklenmiştir.</h4> 
							<hr />
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input  name="katalog_adi" maxlength="60" required class="form-control" type="text" required/>
                                            <p class="help-block">Katalog Adı giriniz.</p>
                                        </div>										
										<div class="form-group">
											<label class="control-label col-lg-4" style="width:100%; margin-left:-15px;">Pdf Dosyası Seç</label>
											<div class="">
                                        ...
                                        <input type="submit" class="btn btn-info" value="Kataloğu Ekle"/>
