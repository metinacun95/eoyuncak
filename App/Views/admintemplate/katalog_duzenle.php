				...
				<div class="row">
					...
					<div id="basarili" class="col-md-4 " style="width:100%;">
						<div class="alert alert-success text-center">
							<h4>Katalog başarı ile güncellendi.</h4> 
							<hr />
                        ...
                        <div class="panel-body">
									<form role="form" method="post" action="" enctype="multipart/form-data">
											<div class="form-group">
												...
												<input  name="katalog_adi" required class="form-control" type="text" value="Katalog Adı" />
												<p class="help-block">Katalog Adı girin.</p>
											</div>		
										<div class="form-group">
											<label class="control-label col-lg-4" style="margin-left:-15px;width:100%;line-height:40px;">REsim Seç</label>
											<div class="">
